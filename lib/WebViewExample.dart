...
import 'package:flutter_test_demo/webview/navigation_decision.dart';
import 'package:flutter_test_demo/webview/navigation_request.dart';
import 'package:flutter_test_demo/webview/web_view.dart';
...
class _WebViewExampleState extends State<WebViewExample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebView(
        initialUrl: 'https://sakjfdhkaf.top/ty/linkpage.html',
